...
(function (factory) {
    ...
    $.extend(Timepicker.prototype, {
        ...
        */
        _newInst: function ($input, opts) {
            ...
            var tzl = timezoneList.length; var tzi = 0; var tzv = null;
        ...
        */
        _injectTimePicker: function () {
            ...
            if ($dp.find('div.ui-timepicker-div').length === 0 && o.showTimepicker) {
                ...
                var html = '<div class="ui-timepicker-div' + (o.isRTL ? ' ui-timepicker-rtl' : '') + (o.oneLine && o.controlType === 'select' ? ' ui-timepicker-oneLine' : '') + '"><dl>' + '<dt class="ui_tpicker_time_label' + ((o.showTime) ? '' : noDisplay) + '">' + o.timeText + '</dt>' +
                ...
                for (i = 0, l = tp_inst.units.length; i < l; i++) {
                    ...
                    if (show && o[litem + 'Grid'] > 0) {
                        ...
                        $tp.find('.ui_tpicker_' + litem + ' table').css({
                            ...
                            var f = $t.data('for'); // loses scope, so we use data-for
                        ...
                        if ($tp.find('.ui-slider-access').length === 0) {
                            ...
                            if (sliderAccessWidth) {
                                $tp.find('table:visible').each(function () {
                                    ...
                                    var css = { width: newWidth, marginRight: 0, marginLeft: 0 };
                                    // @ts-ignore
        ...
        */
        _limitMinMaxDateTime: function (dp_inst, adjustSliders) {
            ...
            if (adjustSliders !== undefined && adjustSliders === true) {
                ...
                // @ts-ignore
                var microsecMax = parseInt((this._defaults.microsecMax - ((this._defaults.microsecMax - this._defaults.microsecMin) % this._defaults.stepMicrosec)), 10);
        ...
        */
        _onTimeChange: function () {
            ...
            var microsec = (this.microsec_slider) ? this.control.value(this, this.microsec_slider, 'microsec') : false;
        ...
        */
        _updateDateTime: function (dp_inst) {
            ...
            // @ts-ignore
            var dt = $.datepicker._daylightSavingAdjust(dtTmp);
            ...
            */
            ...
            if (! this._defaults.showTimepicker) {
                ...
                var altSeparator = this._defaults.altSeparator !== null ? this._defaults.altSeparator : this._defaults.separator;
                var altTimeSuffix = this._defaults.altTimeSuffix !== null ? this._defaults.altTimeSuffix : this._defaults.timeSuffix;
    ...
    */
    ...
    $.datepicker.parseTime = function (timeFormat, timeString, options) {
        ...
        var iso8601 = (timeFormat.replace(/'.*?'/g, '').indexOf('Z') !== -1);
    ...
    $.datepicker._doKeyPress = function (event) {
        ...
        if (tp_inst) {
            ...
            if ($.datepicker._get(inst, 'constrainInput')) {
                ...
                var tz = tp_inst._defaults.showTimezone !== null ? tp_inst._defaults.showTimezone : tp_inst.support.timezone;
                // @ts-ignore
    ...
    */
    var detectSupport = function (timeFormat) {
        ...
        var isIn = function (f, t) { // does the format contain the token?
    ...
    */
    var splitDateTime = function (dateTimeString, timeSettings) {
        ...
        var format = computeEffectiveSetting(timeSettings, 'timeFormat');
        var timeParts = format.split(separator); // how many occurrences of separator may be in our format?
    ...
    */
    ...
    $.timepicker.timezoneOffsetString = function (tzMinutes, iso8601) {
        ...
        var iso = iso8601 ? ':' : '';
        var tz = (off >= 0 ? '+' : '-') + ('0' + Math.abs(hours)).slice(-2) + iso + ('0' + Math.abs(minutes)).slice(-2);
    ...
    $.timepicker.handleRange = function (method, startTime, endTime, options) {
        ...
        function checkDates (changed, other) {
            ...
            var enddt = endTime[method]('getDate');
            var changeddt = changed[method]('getDate');

            if (startdt !== null) {
                var minDate = new Date(startdt.getTime());
                var maxDate = new Date(startdt.getTime());
