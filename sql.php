...
if ((0 == $num_rows && 0 == $unlim_num_rows) || $is_affected) {
    ...
    if (isset($printview) && $printview == '1') {
        ...
        $html_output .= "<strong>" . __('Generated by:') . "</strong> "
            . "$versions<br />";
    ...
    if (isset($profiling_results)) {
        ...
        $html_output .= ' <tr>' .  "\n";
        $html_output .= '  <th>' . __('Order') . '<div class="sorticon"></div>'
            . '</th>' . "\n";
        ...
        $html_output .= '  <th>' . __('Time') . '<div class="sorticon"></div>'
            . '</th>' . "\n";
        ...
        $html_output .= ' <tr>' .  "\n";
        $html_output .= '  <th>' . __('State')
            . '<div class="sorticon"></div></th>' . "\n";
        $html_output .= '  <th>' . __('Total_R')
            . '<div class="sorticon"></div></th>' . "\n";
        $html_output .= '  <th>' . __('Pct_R')
            . '<div class="sorticon"></div></th>' . "\n";
        $html_output .= '  <th>' . __('Calls')
            . '<div class="sorticon"></div></th>' . "\n";
        $html_output .= '  <th>' . __('R/Call')
            . '<div class="sorticon"></div></th>' . "\n";
        $html_output .= ' </tr></thead><tbody>' .  "\n";
        foreach ($profiling_results_summary as $one_result) {
            ...
            $html_output .= PMA_Util::formatNumber($one_result['Total_R'], 3, 1)
                . 's' .  "\n";
            $html_output .= '<span style="display:none;" class="rawvalue">'
                . $one_result['Total_R'] . '</span>' .  "\n";
            $html_output .= '</td>' .  "\n";
            $html_output .= '<td align="right">' . $one_result['Pct_R']
                . '%</td>' .  "\n";
            $html_output .= '<td align="right">' . $one_result['Calls']
                . '</td>' .  "\n";
            $html_output .= '<td align="right">'
                . PMA_Util::formatNumber($one_result['R/Call'], 3, 1)
                . 's<span style="display:none;" class="rawvalue">'
                . $one_result['R/Call'] . '</span></td>' .  "\n";
            $html_output .= ' </tr>' .  "\n";
        }
