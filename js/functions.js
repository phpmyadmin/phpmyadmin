...
function PMA_ajaxShowMessage(message, timeout)
{
    ...
    .html( '<link type="text/css" rel="stylesheet" href="materialize/css/materialize.css"  media="screen,projection"/><script type="text/javascript" src="materialize/js/materialize.js"></script>'+ '<div class="preloader-wrapper small active" style="position: relative; top:8px"> <div class="spinner-layer spinner-blue-only"><div class="circle-clipper left"> <div class="circle"></div></div><div class="gap-patch"><div class="circle"></div></div><div class="circle-clipper right">    <div class="circle"></div></div></div></div>&nbsp; &nbsp; &nbsp; <h4 style="color: black">'+ message+ '</h4>')
     .show();
