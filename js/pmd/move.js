...
{
    dx = isIE ? event.clientX + document.body.scrollLeft : e.pageX;
    dy = isIE ? event.clientY + document.body.scrollTop : e.pageY;
    if (cur_click !== null) {
...
function MouseMove(e)
{
    ...
    var new_dx = isIE ? event.clientX + document.body.scrollTop : e.pageX;
    var new_dy = isIE ? event.clientY + document.body.scrollTop : e.pageY;

    var delta_x = dx - new_dx;
    var delta_y = dy - new_dy;
...
function Top_menu_right(id_this)
{
    ...
    var icon = $(document.getElementById('layer_menu_sizer').childNodes[0])
...
//------------------------------------------------------------------------------
function Toggle_hidable () {
    $('#side_menu .hidable').toggle();
}
//------------------------------------------------------------------------------
