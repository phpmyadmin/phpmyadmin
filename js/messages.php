...
$javascriptMessages = [
    ...
    'strDatabaseRenameToSameName' => __('Cannot rename database to the same name. Change the name and try again'),
    ...
    'strPreviousSaveQuery' => __('You have a previously saved query. Click Get auto-saved query to load the query.'),
