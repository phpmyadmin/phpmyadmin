...
AJAX.registerOnload('server/status/monitor.js', function () {
  ...
  function initGrid() {
    ...
    chartSpacing = {
      width: $('#chartGrid').find(document.querySelectorAll('td:nth-child(2)')).offset().left - $('#chartGrid').find(document.querySelectorAll('td:nth-child(1)')).offset().left,
      height: $('#chartGrid').find(document.querySelectorAll('td:nth-child(2) td:nth-child(2)')).offset().top - $('#chartGrid').find(document.querySelectorAll('td:nth-child(1) td:nth-child(1)')).offset().top
    };
    $('#chartGrid').html('');
  ...
  function loadQueryAnalysis(rowData) {
    ...
    $.post('index.php?route=/server/status/monitor/query', {
      ...
      $('#queryAnalyzerDialog').find('div.placeHolder').html('<table width="100%" border="0"><tr><td class="explain"></td><td class="chart"></td></tr></table>');
