 ...
 * @return Object
 */
export function traverseNavigationForPaths () {
    var params = {
 ...
 * @returns void
 */
export function navTreeStateUpdate () {
...
export function PMA_selectCurrentDb () {
...
export function PMA_showCurrentNavigation () {
    ...
    function loadAndShowTableOrView ($expander, $relatedContainer, itemName) {
        loadChildNodes(true, $expander, function () {
 ...
 * @returns void
 */
export function loadChildNodes (isNode, $expandElem, callback) {
 ...
 * @returns void
 */
export function expandTreeNode ($expandElem, callback) {
 ...
 * @return void
 */
export function PMA_disableNaviSettings () {
 ...
 * @return void
 */
export function PMA_showFullName ($containerELem) {
 ...
 * @returns void
 */
export function navFilterStateRestore () {
    if (isStorageSupported('sessionStorage')
        ...
        $tableFilters.each(function () {
            let $obj = $(this).closest('div.list_container');
 ...
 *
 */
export function scrollToView ($element, $forceToTop) {
 ...
 * @returns void
 */
export function navFilterStateUpdate (filterName, filterValue) {
    if (isStorageSupported('sessionStorage')) {
        var storage = window.sessionStorage;
        try {
 ...
 * @returns void
 */
export function collapseTreeNode ($expandElem) {
    var $children = $expandElem.closest('li').children('div.list_container');
    var $icon = $expandElem.find('img');
    if ($expandElem.hasClass('loaded')) {
 ...
 */
export var ResizeHandler = function () {
    /**
