...
function PMA_getSqlQueriesForDisplayAndAddUser($username, $hostname, $password)
{
    ...
    $slashedEscapedUsername = PMA\libraries\Util::sqlAddSlashes($escapedUsername);
    $slashedEscapedHostname = PMA\libraries\Util::sqlAddSlashes($escapedHostname);
    ...
    if ($_POST['pred_password'] != 'none' && $_POST['pred_password'] != 'keep') {
        $slashedPassword = PMA\libraries\Util::sqlAddSlashes($_POST['pma_pw']);
