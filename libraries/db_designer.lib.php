...
{
    // @gzzhanghao:
    // TODO: Make the menu obey $cfg['TabsMode']
    ...
    if (!PMA_Util::showIcons('TabsMode')) {
        $toggleText = 'Toggle icons';
        $iconClass = 'hide hidable';
        $textClass = '';
    }
    if (!PMA_Util::showText('TabsMode')) {
        $textClass = 'hide hidable';
    }
    ...
    $html .= '<a id="key_Show_left_menu" href="#" target="_self">';
    $html .= '<img class="' . $iconClass . '" title="' . __('Show/Hide left menu') . '" alt="v" ';
    $html .= 'src="' . $_SESSION['PMA_Theme']->getImgPath('pmd/downarrow2_m.png')
        . '" />';
    $html .= '<span class="' . $textClass . '">' . __('Show/Hide left menu') . '</span>';
    $html .= '</a>';
    ...
    $html .= '<a href="#" target="_self" id="key_Left_Right">';
    ...
    $html .= '<a href="#" target="_self" id="toggle_Hidable">';
    $html .= '<img class="' . $iconClass . '" title="' . __($toggleText) . '" alt=">"';
    $html .= 'src="' . $_SESSION['PMA_Theme']->getImgPath('pmd/2rightarrow_m.png')
        . '" />';
    $html .= '<span class="' . $textClass . '">' . __($toggleText) . '</span>';
    $html .= '</a>';
