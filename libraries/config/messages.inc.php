...
$strConfigNaviTopIconic_desc = __('Use only icons, only text or both');
$strConfigNaviTopIconic_name = __('Navigation panel top menu');
...
$strConfigMainMenuIconic_desc = __('Use only icons, only text or both');
$strConfigMainMenuIconic_name = __('Iconic main menu');
