...
$strConfigDefaultLanguage = __('Default language');
...
$strConfigDefaultServer = __('Default server');
...
$strConfigForm_Ldi = __('CSV using LOAD DATA');
$strConfigForm_Ldi_desc = __('Customize default options');
...
$strConfigIgnoreErrors = __('Ignore errors');
...
$strConfigLetUserChoose = __('let the user choose');
...
$strConfigRevertErroneousFields = __('Try to revert erroneous fields to their default values');
...
$strConfigShowForm = __('Show form');
...
$strConfigShowHiddenMessages = __('Show hidden messages (#MSG_COUNT)');
