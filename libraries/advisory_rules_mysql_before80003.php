...
return [
    ...
    [
        ...
        'recommendation' => __('The query cache is known to greatly improve performance if configured correctly. Enable it by setting {query_cache_size} to a 2 digit MiB value and setting {query_cache_type} to \'ON\'. <b>Note:</b> If you are using memcached, ignore this recommendation.'),
    ...
    [
        ...
        'recommendation' => __('This might be caused by {query_cache_limit} being too low. Flushing the query cache might help as well.'),
        'justification' => __('The current ratio of free query cache memory to total query cache size is %s%%. It should be above 80%%'),
        'justification_formula' => 'round(value,1)',
    ],
    [
        ...
        'justification' => __('The cache is currently fragmented by %s%% , with 100%% fragmentation meaning that the query cache is an alternating pattern of free and used blocks. This value should be below 20%%.'),
        'justification_formula' => 'round(value,1)',
    ],
    [
        ...
        'recommendation' => __('You might want to increase {query_cache_size}, however keep in mind that the overhead of maintaining the cache is likely to increase with its size, so do this in small increments and monitor the results.'),
        'justification' => __('The ratio of removed queries to inserted queries is %s%%. The lower this value is, the better (This rules firing limit: 0.1%%)'),
        'justification_formula' => 'round(value,1)',
    ],
    [
        ...
        'issue' => __('The query cache size is above 128 MiB. Big query caches may cause significant overhead that is required to maintain the cache.'),
        'recommendation' => __('Depending on your environment, it might be performance increasing to reduce this value.'),
