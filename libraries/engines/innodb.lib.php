        ...
        switch ($id) {
            case 'bufferpool':
                ...
                $output = '<table>' . "\n"
                        ...
                        . '            </td>' . "\n"
                        . '            <td bgcolor="' . $cfg['BgcolorTwo'] . '">' . "\n"
                        . '                &nbsp;' . $GLOBALS['strBufferWriteWaitTime'] . '&nbsp;' . "\n"
                        . '            </td>' . "\n"
                        . '            <td align="right" bgcolor="' . $cfg['BgcolorTwo'] . '">' . "\n"
                        . '                ' . htmlspecialchars($status['Innodb_buffer_pool_wait_free']) . 's' . "\n"
                        . '            </td>' . "\n"
                        . '        </tr>' . "\n"
                        . '        <tr>' . "\n"
                        . '            <td bgcolor="' . $cfg['BgcolorOne'] . '">' . "\n"
                        ...
                        . '            </td>' . "\n"
                        . '            <td bgcolor="' . $cfg['BgcolorOne'] . '">' . "\n"
                        . '                &nbsp;' . $GLOBALS['strAverageBufferWriteWaitTimePerRequest'] . '&nbsp;' . "\n"
                        . '            </td>' . "\n"
                        . '            <td align="right" bgcolor="' . $cfg['BgcolorTwo'] . '">' . "\n"
                        . '                ' . htmlspecialchars(number_format($status['Innodb_buffer_pool_wait_free'] / $status['Innodb_buffer_pool_write_requests'], 2, $GLOBALS['number_decimal_separator'], $GLOBALS['number_thousands_separator'])) . 's' . "\n"
                        . '            </td>' . "\n"
                        . '        </tr>' . "\n"
                        . '    </tbody>' . "\n"
                        . '</table>' . "\n";
