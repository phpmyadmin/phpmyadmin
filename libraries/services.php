...
return [
    'services' => [
        ...
        'config' => ['class' => PhpMyAdmin\Config::class],
        'central_columns' => ['class' => PhpMyAdmin\Database\CentralColumns::class, 'arguments' => ['@dbi']],
        'check_user_privileges' => ['class' => PhpMyAdmin\CheckUserPrivileges::class, 'arguments' => ['@dbi']],
        'create_add_field' => ['class' => PhpMyAdmin\CreateAddField::class, 'arguments' => ['@dbi']],
        'designer' => [
        ...
        'error_handler' => ['class' => PhpMyAdmin\ErrorHandler::class],
        'error_report' => [
            'class' => PhpMyAdmin\ErrorReport::class,
            'arguments' => ['@http_request', '@relation', '@template', '@config'],
        ],
        'events' => ['class' => PhpMyAdmin\Database\Events::class, 'arguments' => ['@dbi','@template','@response']],
        'export' => ['class' => PhpMyAdmin\Export::class, 'arguments' => ['@dbi']],
        'export_options' => [
            'class' => PhpMyAdmin\Export\Options::class,
            'arguments' => ['@relation', '@export_template_model'],
        ],
        'export_template_model' => ['class' => PhpMyAdmin\Export\TemplateModel::class, 'arguments' => ['@dbi']],
        'expression_language' => ['class' => Symfony\Component\ExpressionLanguage\ExpressionLanguage::class],
        'file_listing' => ['class' => PhpMyAdmin\FileListing::class],
        'flash' => ['class' => PhpMyAdmin\FlashMessages::class],
        'http_request' => ['class' => PhpMyAdmin\Utils\HttpRequest::class],
        'import' => ['class' => PhpMyAdmin\Import::class],
        'import_simulate_dml' => ['class' => PhpMyAdmin\Import\SimulateDml::class, 'arguments' => ['@dbi']],
        'insert_edit' => [
        ...
        'replication' => ['class' => PhpMyAdmin\Replication\Replication::class, 'arguments' => ['$dbi' => '@dbi']],
        'replication_gui' => [
        ...
        'server_plugins' => ['class' => PhpMyAdmin\Server\Plugins::class, 'arguments' => ['@dbi']],
        'server_privileges' => [
        ...
        'status_data' => ['class' => PhpMyAdmin\Server\Status\Data::class, 'arguments' => ['@dbi','@config']],
        'status_monitor' => ['class' => PhpMyAdmin\Server\Status\Monitor::class, 'arguments' => ['@dbi']],
        'status_processes' => ['class' => PhpMyAdmin\Server\Status\Processes::class, 'arguments' => ['@dbi']],
        ...
        'transformations' => ['class' => PhpMyAdmin\Transformations::class],
        'triggers' => [
        ...
        'user_preferences' => ['class' => PhpMyAdmin\UserPreferences::class, 'arguments' => ['@dbi']],
        'version_information' => ['class' => PhpMyAdmin\VersionInformation::class],
