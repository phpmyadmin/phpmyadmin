    ...
    private function setMessages(): array
    {
        return [
            ...
            'strAllowNoPassowrdIsFalse' => __(
                'You are trying to set this account to log in without a password but the configuration directive AllowNoPassword is false. If you procced, the account will not be able to log in through phpMyAdmin. Do you wish to procced ? '
            ),
