...
class ThemeGenerator
{
    ...
    public function createFileStructure(array $post)
    {
        ...
        $this->createLayoutFile($post);
        $this->createNavigationFile($name);
        return null;
    }
    ...
    public function createNavigationFile($name)
    {
        ...
        $txt .= '    <?php echo $left; ?>: 0;';
        $txt .= '    height: 100vh;';
        $txt .= '    background: linear-gradient(to right, <?php echo $GLOBALS[\'cfg\'][\'NaviBackground\']; ?> , <?php echo $GLOBALS[\'cfg\'][\'NaviBackground\']; ?>96);';
    ...
    public function createLayoutFile(array $post)
    {
        ...
        $txt .= '$GLOBALS[\'cfg\'][\'NaviPointerBackground\']    = \'#ddd\';';
        /**
         * main frame
         */
        ...
        $txt .= '$GLOBALS[\'cfg\'][\'MainBackground\']           = \'#fff\';';
        ...
        $txt .= '$GLOBALS[\'cfg\'][\'ThBackground\']         = \'#D3DCE3\';';
        // table header and footer background
        $txt .= '$GLOBALS[\'cfg\'][\'ThColor\']              = \'#000\';';
        // table data row background
        $txt .= '$GLOBALS[\'cfg\'][\'BgOne\']                = \'#E5E5E5\';';
        // table data row background, alternate
        $txt .= '$GLOBALS[\'cfg\'][\'BgTwo\']                = \'#D5D5D5\';';
