...
class Normalization
{
     ...
     * @param string $table current table
     *
     * @return array{legendText: string, headText: string, subText: string, hasPrimaryKey: string, extra: string} HTML contents for step 1.2
     */
     ...
     * @param string $table current table
     *
     * @return array{legendText: string, headText: string, subText: string, extra: string, primary_key: false|string} HTML contents for step 1.3
     */
