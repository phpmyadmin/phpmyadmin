 ...
 * @param string $rownumber_param       row number parameters
...
function PMA_getHtmlForColumn($table_columns, $i, $column, $comments_map,
    ...
    $table, $db, $rownumber_param, $titles, $biggest_max_file_size,
    ...
    if ($GLOBALS['cfg']['ShowFieldTypesInDataEditView']) {
        $html_output .= PMA_getHtmlForFieldType($column);
    } //End if
...
function PMA_getHtmlForInsertEditRow($url_params, $table_columns,
    ...
    $tabindex_for_value, $table, $db, $rownumber_param, $titles,
