...
final class CheckRelationsControllerTest extends AbstractTestCase
{
    ...
    public function createConfigStorage(): void
    {
        ...
        $dbiDummy->addResult("-- -------------------------------------------------------- -- -- Table structure for table `pma__users` -- CREATE TABLE IF NOT EXISTS `pma__users` ( `username` varchar(64) NOT NULL, `usergroup` varchar(64) NOT NULL, PRIMARY KEY (`username`) ) COMMENT='Users and their assignments to user groups' DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;", true);
