...
class CollationTest extends AbstractTestCase
{
    ...
    public static function providerTestBuildDescription(): array
    {
        return [
            ...
            ['utf8_myanmar_ci', 'Burmese, case-insensitive'],
            ['utf8mb4_la_0900_as_cs', 'Classical Latin (UCA 9.0.0), accent-sensitive, case-sensitive'],
            ['utf8_sinhala_ci', 'Sinhalese, case-insensitive'],
            ['utf8_vietnamese_ci', 'Vietnamese, case-insensitive'],
            ['gb18030_chinese_ci', 'Chinese, case-insensitive'],
            ['utf8mb4_ja_0900_as_cs_ks', 'Japanese (UCA 9.0.0), accent-sensitive, case-sensitive, kana-sensitive'],
            ['utf8mb4_unicode_520_nopad_ci', 'Unicode (UCA 5.2.0), no-pad, case-insensitive'],
            ['utf8mb4_ru_0900_as_cs', 'Russian (UCA 9.0.0), accent-sensitive, case-sensitive'],
        ];
    }
}
