...
<?php
    ...
    if (! empty($message)) {
?>
    <?= PMA\libraries\Util::getMessage($message) ?>
<?php
        unset($message);
    }
...
<?php // Anchor for favorite tables synchronization.?>
    <?= RecentFavoriteTable::getInstance('favorite')->getHtmlSyncFavoriteTables() ?>
...
?>
                    <li id="li_select_server" class="no_bullets">
                        <?= PMA\libraries\Util::getImage('s_host.png') . " " . PMA_selectServer(true, true) ?>
                    </li>
<?php
        }
                    ...
                    <li id="li_select_mysql_collation" class="no_bullets" >
                        <form method="post" action="index.php">
                            ...
                            <label for="select_collation_connection">
                                ...
                                <?php // put the doc link in the form so that it appears on the same line ?>
...
?>
                    <li id="li_select_lang" class="no_bullets">
                        <?= PMA\libraries\Util::getImage('s_lang.png') . " " . PMA_getLanguageSelectorHtml() ?>
                    </li>
<?php
    }
...
?>
                    <li id="li_select_theme" class="no_bullets">
                        <?= PMA\libraries\Util::getImage('s_theme.png') ?>
