...
$cfg['LeftPointerColor']    = '#ffffff';    // color of the pointer in left frame
$cfg['Border']              = 0;            // border width on tables
$cfg['ThBgcolor']           = '#82a9e9';    // table header row colour
$cfg['BgcolorOne']          = '#eae6d0';    // table data row colour
$cfg['BgcolorTwo']          = '#f8f8f1';    // table data row colour, alternate
$cfg['BrowsePointerColor']  = '#d6dff7';           // color of the pointer in browse mode
$cfg['BrowseMarkerColor']   = '#ccccff';    // color of the marker (visually marks row
