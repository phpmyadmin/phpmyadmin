...
$cfg['LeftBgColor']         = '#fedea6';    						// background color for the left frame
...
$cfg['ThBgcolor']           = '#fedea6';    						// table header row colour
$cfg['BgcolorOne']          = '#f5f5f5';    						// table data row colour
$cfg['BgcolorTwo']          = '#f0f0f0';    						// table data row colour, alternate
$cfg['BrowsePointerColor']  = '#ffeab8';    						// color of the pointer in browse mode
