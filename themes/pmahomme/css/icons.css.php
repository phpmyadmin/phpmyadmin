...
.ic_b_column_add { background-image: url('<?= $theme->getImgPath('b_column_add.png'); ?>'); zoom: 1;}
...
.ic_b_docs { background-image: url('<?= $theme->getImgPath('b_docs.png'); ?>');zoom: 2; }
...
.ic_b_engine { background-image: url('<?= $theme->getImgPath('1_engines.png'); ?>'); }
...
.ic_b_export { background-image: url('<?= $theme->getImgPath('1_export.png'); ?>'); }
...
.ic_b_import { background-image: url('<?= $theme->getImgPath('1_import.png'); ?>'); }
.ic_b_index { background-image: url('<?= $theme->getImgPath('b_index.png'); ?>'); zoom: 1;}
.ic_b_index_add { background-image: url('<?= $theme->getImgPath('b_index_add.png'); ?>');zoom: 1; }
...
.ic_b_minus { background-image: url('<?= $theme->getImgPath('b_minus.png'); ?>'); zoom: 1; }
.ic_b_more { background-image: url('<?= $theme->getImgPath('b_more.png'); ?>'); }
.ic_b_move { background-image: url('<?= $theme->getImgPath('b_move.png'); ?>'); }
.ic_b_newdb { background-image: url('<?= $theme->getImgPath('b_newdb.png'); ?>'); zoom: 1;}
...
.ic_b_plugin { background-image: url('<?= $theme->getImgPath('1_plugins.png'); ?>'); }
.ic_b_plus { background-image: url('<?= $theme->getImgPath('b_plus.png'); ?>');zoom: 1  ; }
...
.ic_b_props { background-image: url('<?= $theme->getImgPath('b_props.png'); ?>'); zoom: 1;}
...
.ic_b_sql { background-image: url('<?= $theme->getImgPath('1_sql.png'); ?>'); }
...
.ic_b_table_add { background-image: url('<?= $theme->getImgPath('b_table_add.png'); ?>'); zoom: 1;}
...
.ic_b_tblops { background-image: url('<?= $theme->getImgPath('1_settings.png'); ?>'); }
...
.ic_b_trigger_add { background-image: url('<?= $theme->getImgPath('b_trigger_add.png'); ?>'); zoom: 1;}
...
.ic_b_usradd { background-image: url('<?= $theme->getImgPath('b_usradd.png'); ?>'); zoom: 1;}
...
.ic_b_view_add { background-image: url('<?= $theme->getImgPath('b_view_add.png'); ?>'); zoom: 1;}
...
.ic_centralColumns { background-image: url('<?= $theme->getImgPath('centralColumns.png'); ?>'); zoom: 1; }
.ic_centralColumns_add { background-image: url('<?= $theme->getImgPath('centralColumns_add.png'); ?>'); zoom: 1;}
.ic_centralColumns_delete { background-image: url('<?= $theme->getImgPath('centralColumns_delete.png'); ?>'); zoom: 1; }
...
.ic_new_struct { background-image: url('<?= $theme->getImgPath('new_struct.png'); ?>'); zoom: 1;}
.ic_new_struct_hovered { background-image: url('<?= $theme->getImgPath('new_struct_hovered.png'); ?>'); zoom: 1;}
.ic_new_struct_selected { background-image: url('<?= $theme->getImgPath('new_struct_selected.png'); ?>'); zoom: 1; }
.ic_new_struct_selected_hovered { background-image: url('<?= $theme->getImgPath('new_struct_selected_hovered.png'); ?>');zoom: 1; }
.ic_normalize { background-image: url('<?= $theme->getImgPath('normalize.png'); ?>'); }
.ic_pause { background-image: url('<?= $theme->getImgPath('pause.png'); ?>');zoom: 1; }
...
.ic_s_asci { background-image: url('<?= $theme->getImgPath('1_asci.png'); ?>'); }
...
.ic_s_db { background-image: url('<?= $theme->getImgPath('1_db.png'); ?>'); zoom: 1;   }
...
.ic_s_replication { background-image: url('<?= $theme->getImgPath('1_replication.png'); ?>'); }
.ic_s_rights { background-image: url('<?= $theme->getImgPath('1_userAccount.png'); ?>'); }
.ic_s_sortable { background-image: url('<?= $theme->getImgPath('s_sortable.png'); ?>'); }
.ic_s_status { background-image: url('<?= $theme->getImgPath('1_status.png'); ?>'); }
...
.ic_s_vars { background-image: url('<?= $theme->getImgPath('1_variables.png'); ?>'); }
