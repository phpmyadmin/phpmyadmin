...
class TemplateTest extends AbstractTestCase
{
    ...
    {
        self::assertEquals($value, $this->template->render($templateFile, [$key => $value]));
    }
    ...
    {
        self::assertEquals($expectedResult, $this->template->render($templateFile));
    }
    ...
    {
        self::assertEquals($expectedResult, $this->template->render($templateFile, $renderParams));
    }
