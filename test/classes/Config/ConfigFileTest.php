...
class ConfigFileTest extends AbstractTestCase
{
    ...
    public function testNewObjectState(): void
    {
        ...
        self::assertEquals([], $this->object->getConfig());

        // Check environment state
        self::assertEquals([], $_SESSION['ConfigFile1']);
    ...
    public function testPersistentKeys(): void
    {
        ...
        self::assertEmpty($this->object->getConfig());
        self::assertEquals($default_config, $this->object->getConfigArray());
         ...
         */
        $this->object->set('Servers/2/host', $default_host);
        self::assertEquals(['Servers' => [2 => ['host' => $default_host]]], $this->object->getConfig());
    }
    ...
    public function testConfigReadMapping(): void
    {
        ...
        self::assertEquals(3, $this->object->get('Servers/1/value1'));
    }
    ...
    public function testSetConfigData(): void
    {
        ...
        self::assertEquals(['a' => 'b'], $this->object->getConfig());
        self::assertEquals(['a' => 'b'], $this->object->getConfigArray());
    }
    ...
    public function testBasicSetUsage(): void
    {
        ...
        self::assertEquals($nondefault_host, $this->object->get('Servers/4/host'));
        self::assertEquals(null, $this->object->get('Servers/5/host'));
        self::assertEquals($default_host, $this->object->get('Servers/6/host'));

        // return default value for nonexistent keys
        self::assertNull($this->object->get('key not excist'));
        self::assertEquals([1], $this->object->get('key not excist', [1]));
    ...
    public function testConfigFileSetInUserPreferences(): void
    {
        ...
        $this->object->set(self::SIMPLE_KEY_WITH_DEFAULT_VALUE, $default_value);
        self::assertEquals([self::SIMPLE_KEY_WITH_DEFAULT_VALUE => $default_value], $this->object->getConfig());
    }
    ...
    public function testGetFlatDefaultConfig(): void
    {
        ...
        $default_value = $this->object->getDefault(self::SIMPLE_KEY_WITH_DEFAULT_VALUE);
        self::assertEquals($default_value, $flat_default_config[self::SIMPLE_KEY_WITH_DEFAULT_VALUE]);

        $localhost_value = $this->object->getDefault('Servers/1/host');
        self::assertEquals($localhost_value, $flat_default_config['Servers/1/host']);
    ...
    {
        self::assertEquals('Servers/1/abcd', $this->object->getCanonicalPath('Servers/2/abcd'));

        self::assertEquals('Servers/foo/bar', $this->object->getCanonicalPath('Servers/foo/bar'));
    }
    ...
    public function testGetDbEntry(): void
    {
        ...
        self::assertEquals($cfg_db['Servers'][1]['port'], $this->object->getDbEntry('Servers/1/port'));
        self::assertNull($this->object->getDbEntry('no such key'));
        self::assertEquals([1], $this->object->getDbEntry('no such key', [1]));
    }
    ...
    public function testGetServerCount(): void
    {
        ...
        self::assertEquals(4, $this->object->getServerCount());

        $this->object->removeServer(2);
        $this->object->removeServer(2);

        self::assertEquals(2, $this->object->getServerCount());
    ...
    {
        self::assertEquals('', $this->object->getServerDSN(1));
        ...
        self::assertEquals('mysqli://testUser@example.com:21', $this->object->getServerDSN(1));
        ...
        self::assertEquals('mysqli://testUser@123', $this->object->getServerDSN(1));
    ...
    {
        self::assertEquals('', $this->object->getServerName(1));

        $this->object->set('Servers/1/host', 'example.com');
        self::assertEquals('example.com', $this->object->getServerName(1));

        $this->object->set('Servers/1/verbose', 'testData');
        self::assertEquals('testData', $this->object->getServerName(1));
    }
