            ...
            'columns' => [
                ...
                [
                    ...
                    'order_link' => '<a href="index.php?route=/sql&server=0&lang=en&db=test_db&table=test_table'
                        ...
                        . '&is_browse_distinct=1&server=0&lang=en" class="sortlink">name <svg fill="currentColor"'
                        . ' role="img" aria-label="" alt="Ascending" class="icon ic_s_asc soimg"><use'
                        . ' xlink:href="./themes/pmahomme/img/icons.svg#s_asc"/></svg> <svg fill="currentColor"'
                        . ' role="img" aria-label="" alt="Descending" class="icon ic_s_desc soimg hide"><use'
                        . ' xlink:href="./themes/pmahomme/img/icons.svg#s_desc"/></svg>'
                        . ' <small>1</small><input type="hidden"'
