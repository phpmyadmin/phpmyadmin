...
class SearchTest extends AbstractTestCase
{
    ...
    public function testBuildSqlQuery(): void
    {
        ...
        self::assertEquals('SELECT DISTINCT *  FROM `PMA` ORDER BY `name` asc', $this->search->buildSqlQuery());
        ...
        self::assertEquals($expected, $this->search->buildSqlQuery());
    }
    ...
    public function testBuildSqlQueryWithWhereClause(): void
    {
        ...
        self::assertEquals('SELECT *  FROM `PMA`', $this->search->buildSqlQuery());

        $_POST['customWhereClause'] = '`table` = \'WhereClause\'';

        self::assertEquals('SELECT *  FROM `PMA` WHERE `table` = \'WhereClause\'', $this->search->buildSqlQuery());
    ...
    public function testBuildSqlQueryWithWhereClauseGeom(): void
    {
        ...
        self::assertEquals('SELECT *  FROM `PMA` WHERE Dimension(`b`) = \'1\'', $this->search->buildSqlQuery());
    }
    ...
    public function testBuildSqlQueryWithWhereClauseEnum(): void
    {
        ...
        self::assertEquals('SELECT *  FROM `PMA` WHERE `rating` = \'PG-13\'', $this->search->buildSqlQuery());
    }
