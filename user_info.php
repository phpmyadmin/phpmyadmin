...
if (!($is_table_exist)) {
    ...
    . "`Contact Information` varchar(20) COLLATE utf8_bin NOT NULL"
    . " COMMENT 'Contact Information Of User',"
    . "`Icon` blob NOT NULL COMMENT 'Icon of User'"
    . ") ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin"
    . " COMMENT='Information Regarding Users of Database'";
       $result = PMA_DBI_try_query($query);
}
...
$html .=   ' <div id = \'user_info\' class = \'user_info\'>'
      ...
      . ' value="' . htmlspecialchars($userdetails[0]) . '"></td></tr>'
      . ' <tr><td>Contact :</td><td><input type = text name = "new_contact"'
      . ' value="' . htmlspecialchars($userdetails[1]) . '"></td></tr>'
      . ' <tr><td>E-mail : </td><td><input type = text name = "new_email"'
      . ' value="' . htmlspecialchars($userdetails[3]) . '"></td></tr>'
      ...
      . ' <tr><td>Icon : </td><td><input type = file name = "new_img" id = "new_img">(max 64KB)</td></tr>'
      . ' </table>'
