...
$strRelationNotSet = 'Lentelë <strong>Relationtable</strong> nerasta arba nenurodyta config.inc.php3 byloje';
$strInfoNotSet = 'Lentelë <strong>table_info</strong> nerasta arba nenurodyta config.inc.php3 byloje';
$strCoordsNotSet = 'Lentelë <strong>table_coords</strong> nerasta arba nenurodyta config.inc.php3 byloje';
