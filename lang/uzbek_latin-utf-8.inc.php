...
$strSetupServers_pmadb_desc = 'Aloqalar, xatcho‘plar va PDF imkoniyatlari uchun ishlatiladigan baza.  Batafsil ma`lumot uchun [a@http://wiki.phpmyadmin.net/pma/pmadb]"pmadb"[/a]ga qarang. Agar foydalanmasangiz, bo‘shqoldiring. Asl qiymati: [kbd]"phpmyadmin"[/kbd]';
...
$strShowStatusThreads_createdDescr = 'Kliyentbilan ulanishni qo‘llab-quvvatlash uchun tuzilgan oqimlarning umumiy soni. O‘zgaruvchi qiymati judakatta bo‘lsa, "thread_cache_size" o‘zgaruvchisining qiymatini oshirish mumkin (lekin u unumdorlikni unchalikham oshirmaydi).';
