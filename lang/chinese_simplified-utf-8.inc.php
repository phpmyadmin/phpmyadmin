...
$strSetupServers_SignonSession_desc = '参见[a@http://wiki.cihar.com/pma/auth_types#signon]认证方式[/a]中的例子';
...
$strSetupServers_bookmarktable_desc = '不使用[a@http://wiki.cihar.com/pma/bookmark]书签 (外链，英文)[/a]功能请留空，默认：[kbd]pma_bookmark[/kbd]';
...
$strSetupServers_controluser_desc = '一个特殊的被限制权限的 MySQL 用户，参见 [a@http://wiki.cihar.com/pma/controluser]wiki (外链，英文)[/a]';
...
$strSetupServers_pmadb_desc = '关系、书签、PDF 功能所用的数据库。参见 [a@http://wiki.cihar.com/pma/pmadb]pmadb (外链，英文)[/a]。不使用请留空。默认： [kbd]phpmyadmin[/kbd]';
$strSetupServers_pmadb_name = 'PMA 数据库';
$strSetupServers_port_desc = 'MySQL 服务器监听的端口，留空为默认';
$strSetupServers_port_name = '服务器端口';
$strSetupServers_relation_desc = '不使用[a@http://wiki.cihar.com/pma/relation]关系链接 (外链，英文)[/a]功能请留空，默认：[kbd]pma_relation[/kbd]';
