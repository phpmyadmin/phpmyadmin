...
$strEmpty = 'Vyprázdni';
$strEmptyResultSet = 'MySQL vrátilo prázdny vısledok (tj. nulovı poèet riadkov).';
$strEnd = 'Koniec';
...
$strIfYouWish = 'Ak si eláte nahra iba urèité ståpce tabu¾ky, špecifikujte ich ako zoznam polí oddelenıch èiarkou.';
$strIgnore = 'Ignorova';
$strIndex = 'Index';
$strIndexes = 'Indexy';
...
$strPmaUriError = '<tt>$cfg[\'PmaAbsoluteUri\']</tt> direktíva MUSÍ by nastavená v konfiguraènom súbore!';
$strPos1 = 'Zaèiatok';
...
$strRevoke = 'Zrusi';
$strRevokeGrant = 'Zruši povolenie pridelova privilégia';
