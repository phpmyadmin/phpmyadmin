...
$strDeletePassword = 'Изтрии паролата'; 
$strDeleteUserMessage = 'Вие изтрихте потребителя'; 
...
$strUnique = 'Уникално';
$strUpdatePassMessage = 'Вие променихте паролата за'; 
$strUpdatePassword = 'Промяна на парола'; 
...
$strEnglishPrivileges = ' Забележка: MySQL privilege names are expressed in English ';  //to translate
...
$strPrimaryKeyHasBeenDropped = 'The primary key has been dropped';//to translate$strRunSQLQuery = 'Run SQL query/queries on database %s';//to translate
$strRunningAs = 'as';
...
$strUpdatePrivMessage = 'You have updated the privileges for %s.';//to translate$strUpdateProfile = 'Update profile:';//to translate
