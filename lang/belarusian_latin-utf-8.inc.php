...
$strEnclosingOptional = 'Układańnie słupkoŭ nie źjaŭlajecca abaviazkovym';
$strEndCut = 'END CUT';
$strEnd = 'Kaniec';
$strEndRaw = 'END RAW';
...
$strIgnoreDuplicates = 'Jignaravać radki, jakija paŭtarajucca';
$strIgnoreInserts = 'Vykarystoŭvać ustaŭki ihnaravańniaŭ';
$strIgnore = 'Jihnaravać';
...
$strInvalidAuthMethod = 'U kanfiguracyi vyznačany niekarektny metad aŭtentyfikacyi:';
$strInvalidColumnCount = 'Kolkaść kalonak musić być bolšaj za nul.';
$strInvalidColumn = 'Vyznačanaja niekarektnaja kalonka (%s)!';
$strInvalidCSVInput = 'Niekarektrnyja CSV-dadzienyja, razbor niemahčymy!';
...
$strUnsupportedCompressionDetected = 'Vy pasprabavali zahruzić fajł z metadam ścisku, jaki niepadtrymlivajecca (%s). Jahonaja padtrymka abo nie realizavanaja, abo adklučanaja ŭ vašaj kanfiguracyi.';
