...
$strAnd = 'Και';
$strAnIndex = 'Ένας νέος Δείκτης προστέθηκε στην ';
$strAny = 'Οποιοδήποτε';
...
$strAPrimaryKey = 'Ένα πρωτεύον κλειδί έχει προστεθεί στο ';
...
$strColumn = 'Στήλη';
$strColumnEmpty = 'Τα ονόματα των στηλών είναι άδεια!';
...
$strDbEmpty = 'Το όνομα της βάσης είναι κενό!';
...
$strDisableMagicQuotes = '<b>Προειδοποίηση:</b> Έχετε ενεργοποιήσει την επιλογή magic_quotes_gpc στις ρυθμίσεις του PHP. Αυτή η έκδοση του PhpMyAdmin δεν μπορεί να λειτουργήσει σωστά μαζί με την επιλογή αυτή. Παρακαλώ ελέγξτε την τεκμηρίωση του PHP στο τμήμα ρυθμίσεων για πληροφορίες πώς να το απενεργοποιήσετε.';
$strDisplay = 'Εμφάνιση';
...
$strEnableMagicQuotes = '<b>Προειδοποίηση:</b> Δεν έχετε ενεργοποιήσει την επιλογή magic_quotes_gpc στις ρυθμίσεις του PHP. Το PhpMyAdmin χρειάζεται αυτήν την επιλογή για να λειτουργήσει σωστά. Παρακαλώ ελέγξτε την τεκμηρίωση του PHP στο τμήμα ρυθμίσεων για πληροφορίες πώς να το ενεργοποιήσετε.';
$strEnclosedBy = 'περιστοιχίζεται από ';
$strEnd = 'Τέλος';
$strEnglishPrivileges = ' Σημείωση: Τα ονόματα Προνομίων της MySQL εκφράζονται στα Αγγλικά ';
$strError = 'λάθος';
$strEscapedBy = 'διαφηγή κατά';
...
$strInsertIntoTable = 'Εισαγωγή στον πίνακα';
...
$strPrinterFriendly = 'Εμφάνιση του πίνακα σε έκδοση φιλική για εκτύπωση';
$strPrintView = 'Εμφάνιση για εκτύπωση';
$strPrivileges = 'Προνόμια';
$strProducedAnError = 'δημιούργησε λάθος.';
...
$strReadTheDocs = 'Ανάγνωση της τεκμηρίωσης';
$strRecords = 'Εγγραφές';
...
$strRunSQLQuery = 'Εκτέλεση επερώτησης/επερωτήσεων SQL στη βάση ';
...
$strTerminatedBy = 'τερματισμένο με';
...
$strUnique = 'Μοναδικό';
$strUpdatePassMessage = 'Έχετε ενημερώσει τον Κωδικό Πρόσβασης για';
$strUpdatePassword = 'Ενημέρωση Κωδικού Πρόσβασης';
$strUpdatePrivMessage = 'Έχετε ενημερώσει τα προνόμια για';
