...
$strDumpComments = 'Oszlop-megjegyzések beszúrása bels"o SQL-megjegyzésként';
...
$strQueryFrameDebug = 'Hibakeres"o információ';
$strQueryFrameDebugBox = 'Aktív változók a lekérési "urlaphoz:\nDB: %s\nTábla: %s\nSzerver: %s\n\nJelenlegi Current változók a lekérési "urlaphoz:\nDB: %s\nTábla: %s\nSzerver: %s\n\nMegnyitó hely: %s\nFrameset hely: %s.';
