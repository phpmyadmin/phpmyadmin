...
$strAccessDeniedExplanation = 'phpMyAdmin sa pokúsil pripoji k MySQL serveru ale ten spojenie odmietol. Skontrolujte prosím meno serveru, pouívate¾ské meno a heslo v súbore config.inc.php3 a s tım, ktoré ste dostali o administrátora MySQL servera.';
$strAction = 'Akcia';
