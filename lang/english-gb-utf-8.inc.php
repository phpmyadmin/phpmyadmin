...
$strCancel = 'Cancel';
$strCanNotLoadExportPlugins = 'Could not load export plug-ins, please check your installation!';
$strCanNotLoadImportPlugins = 'Could not load import plug-ins, please check your installation!';
...
$strDataSyn = 'Data Synchronisation';
...
$strHaveBeenSynchronized = 'Selected target tables have been synchronised with source tables.';
...
$strInvalidLDIImport = 'This plug-in does not support compressed imports!';
...
$strOptimize = 'Optimise';
$strOptimizeTable = 'Optimise table';
$strOptions = 'Options';
$strOr = 'Or';
...
$strReplicationSynchronize = 'Synchronise databases with master';
...
$strSetupForm_Browse_desc = 'Customise browse mode';
$strSetupForm_Edit_desc = 'Customise edit mode';
$strSetupForm_Edit = 'Edit mode';
$strSetupForm_Export_defaults_desc = 'Customise default export options';
$strSetupForm_Export_defaults = 'Export defaults';
$strSetupForm_Import_defaults_desc = 'Customise default common import options';
...
$strSetupForm_Left_frame_desc = 'Customise appearance of the navigation frame';
...
$strSetupForm_Query_window_desc = 'Customise query window options';
...
$strSetupFormset_customization = 'Customisation';
$strSetupFormset_export = 'Customise export options';
$strSetupFormset_features = 'Features';
$strSetupFormset_import = 'Customise import defaults';
$strSetupFormset_left_frame = 'Customise navigation frame';
$strSetupFormset_main_frame = 'Customise main frame';
$strSetupForm_Sql_box_desc = 'Customise links shown in SQL Query boxes';
...
$strSetupForm_Startup_desc = 'Customise startup page';
...
$strSetupQueryHistoryDB_desc = 'Enable if you want DB-based query history (requires pmadb). If disabled, this utilises JS-routines to display query history (lost by window close).';
...
$strShowStatusHandler_read_prevDescr = 'The number of requests to read the previous row in key order. This read method is mainly used to optimise ORDER BY ... DESC.';
...
$strShowStatusLast_query_costDescr = 'The total cost of the last compiled query as computed by the query optimiser. Useful for comparing the cost of different query plans for the same query. The default value of 0 means that no query has been compiled yet.';
...
$strShowStatusTable_locks_waitedDescr = 'The number of times that a table lock could not be acquired immediately and a wait was needed. If this is high, and you have performance problems, you should first optimise your queries, and then either split your table or tables or use replication.';
...
$strStructureSyn = 'Structure Synchronisation';
$strSubmit = 'Submit';
...
$strSynchronizationNote = 'Target database will be completely synchronised with source database. Source database will remain unchanged.';
$strSynchronizeDb = 'Synchronise Databases';
$strSynchronize = 'Synchronise';
...
$strTakeIt = 'take it';
$strTargetDatabaseHasBeenSynchronized = 'Target database has been synchronised with source database';
...
$strValidatorError = 'The SQL validator could not be initialised. Please check if you have installed the necessary PHP extensions as described in the %sdocumentation%s.';
$strValue = 'Value';
$strVar = 'Variable';
