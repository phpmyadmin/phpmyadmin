...
$strCoordsNotSet = 'Table PMA_table_coords absente ou non définie dans config.inc.php(3)';
...
$strInfoNotSet = 'Table PMA_table_info absente ou non définie dans config.inc.php(3)';
$strInsert = 'Insérer';
...
$strRelationNotSet = 'Table PMA_relation absente ou non définie dans config.inc.php(3)';
