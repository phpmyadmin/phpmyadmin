...
$strBookmarkQuery = 'Requêtes SQL en signets';
$strBookmarkReplace = 'Remplacer un signet existant du même nom';
$strBookmarkThis = 'Conserver cette requête SQL dans les signets';
...
$strConnectionError = 'Connexion impossible: paramètres incorrects.';
...
$strCreationDates = 'Dates de création/mise à jour/vérification';
$strCriteria = 'Critère';
$strCroatian = 'Croate';
$strCSV = 'CSV';
...
$strDatabaseExportOptions = 'Options d\'exportation des bases de données';
...
$strDelayedInserts = 'Insertions avec délai';
...
$strEmptyResultSet = 'MySQL a retourné un résultat vide (aucune ligne).';
$strEmpty = 'Vider';
$strEnabled = 'Activé';
...
$strFileAlreadyExists = 'Le fichier %s existe déjà sur le serveur, veuillez changer le nom, ou cocher l\'option d\'écrasement des fichiers existants.';
...
$strHebrew = 'Hébreu';
$strHelp = 'Aide';
$strHexForBLOB = 'Utiliser l\'hexadécimal pour un BLOB';
$strHide         = 'Cacher';
...
$strIgnore = 'Ignorer';
$strIgnoreInserts = 'Ne pas insérer une ligne faisant doublon avec une clé unique';
$strImportColNames = 'Noms de colonnes en première ligne';
...
$strImportNoticePt3 = 'Modifiez l\'un des paramètres en cliquant le lien «Options» correspondant';
...
$strInvalidServerHostname = 'Nom d\'hôte invalide pour le serveur %1$s. Veuillez vérifier votre configuration.';
...
$strLatexContinuedCaption = 'Inclure les sous-titres';
...
$strMyISAMDataPointerSizeDesc = 'La taille en octets du pointeur qui servira lors d\'un CREATE TABLE sur une table MyISAM si aucune option MAX_ROWS n\'est indiquée.';
...
$strMysqlLibDiffersServerVersion = 'La version de votre bibliothèque MySQL (%s) de PHP diffère de la version de votre serveur MySQL (%s). Ceci peut occasionner un comportement imprévisible.';
...
$strNoFrames = 'phpMyAdmin est plus convivial avec un navigateur <b>supportant les cadres</b>.';
...
$strPrivDescReload = 'Permission de recharger les paramètres du serveur, et de vidanger la mémoire cache.';
...
$strPrivDescShutdown = 'Permission d\'arrêter le serveur.';
...
$strRunSQLQuery = 'Exécuter une ou des requêtes SQL sur la base %s';
...
$strSearchNeedle = 'Mot(s) ou valeur(s) à rechercher (passe-partout: «%») :';
...
$strServerVars = 'Variables et paramètres du serveur';
...
$strSetupAllowArbitraryServer_desc = 'Si activé, permet d\'entrer un nom de serveur MySQL sur le panneau de connexion en mode cookie';
...
$strSetupBrowseMarkerEnable_name = 'Activer le marqueur de lignes';
...
$strSetupConfirm_desc = 'Un message (Êtes-vous certain...) devrait-il s\'afficher quand vous êtes sur le point de perdre des données';
...
$strSetupDisplayDatabasesList_desc = 'Montrer la liste des bases de données au lieu d\'un menu déroulant';
$strSetupDisplayDatabasesList_name = 'Affiche les bases de données sous forme de liste';
$strSetupDisplayServersList_desc = 'Montrer la liste des serveurs au lieu d\'un menu déroulant';
...
$strSetupForeignKeyDropdownOrder_desc = 'Ordre du tri pour les éléments de clé étrangère; [kbd]content[/kbd] signifie la donnée référencée, [kbd]id[/kbd] représente la valeur de la clé';
...
$strSetupForm_Other_core_settings = 'Autres paramètres de base';
$strSetupForm_Other_core_settings_desc = 'Paramètres divers';
$strSetupForm_Query_window_desc = 'Personnaliser le panneau de requêtes';
$strSetupForm_Query_window = 'Fenêtre de requête';
$strSetupForm_Security_desc = 'Veuillez noter que phpMyAdmin n\'est qu\'une interface et que ses fonctionnalités ne limitent en rien MySQL';
...
$strSetupCharTextareaCols_desc = 'Nombre de colonnes pour les textareas CHAR/VARCHAR';
$strSetupCharTextareaCols_name = 'Taille horizontale pour un textarea contenant un CHAR';
$strSetupCharTextareaRows_desc = 'Nombre de lignes pour les textareas CHAR/VARCHAR';
$strSetupCharTextareaRows_name = 'Taille verticale pour un textarea contenant un CHAR';
...
$strSetupLeftDisplayLogo_desc = 'Montrer le logo dans le panneau de navigation';
$strSetupLeftDisplayLogo_name = 'Affichage du logo';
$strSetupLeftDisplayServers_desc = 'Montrer le choix de serveurs au haut du panneau de navigation';
$strSetupLeftDisplayServers_name = 'Affiche la liste des serveurs';
$strSetupLeftFrameDBSeparator_desc = 'Chaîne qui sépare les noms de bases de données en niveaux';
$strSetupLeftFrameDBSeparator_name = 'Séparateur pour l\'arborescence des bases de données';
$strSetupLeftFrameDBTree_desc = 'En affichage léger; afficher les bases de données en arborescence (déterminé par le séparateur défini plus bas)';
...
$strSetupLeftFrameTableSeparator_desc = 'Chaîne qui sépare les noms de table en niveaux';
...
$strSetupLeftPointerEnable_desc = 'Faire ressortir le nom du serveur dans le panneau de navigation';
...
$strSetupLoginCookieRecall_desc = 'Sur le panneau de connexion du mode cookie, le nom du précédent utilisateur devrait-il apparaître?';
$strSetupLoginCookieRecall_name = 'Se souvenir du nom d\'utilisateur';
$strSetupLoginCookieStore_desc = 'Définit pendant combien de temps (en secondes) le cookie de connexion sera conservé dans le fureteur. La valeur par défaut de 0 signifie qu\'il ne sera conservé que pour la session; ceci est recommandé si l\'environnement n\'est pas digne de confiance.';
$strSetupLoginCookieStore_name = 'Stockage du cookie';
$strSetupLoginCookieValidity_desc = 'Définit pendant combien de temps (en secondes) la connexion demeure valide';
...
$strSetupLoginCookieValidity_name = 'Durée de validité de la connexion en mode cookie';
$strSetupMaxDbList_desc = 'Nombre maximum de bases de données affichées dans le panneau de gauche et la liste des bases';
$strSetupMaxDbList_name = 'Nombre maximum de bases de données';
$strSetupMaxCharactersInDisplayedSQL_desc = 'Nombre maximum de caractères quand une requête SQL est affichée';
...
$strSetupMaxTableList_desc = 'Nombre maximum de tables affichées dans la liste des tables';
...
$strSetupPropertiesIconic_desc = 'Afficher seulement des icônes, seulement du texte ou les deux';
...
$strSetupServers_compress_desc = 'Comprime la connexion au serveur MySQL';
$strSetupServers_compress_name = 'Utiliser le mode compression sur la connexion';
$strSetupServers_connect_type_desc = 'Comment se connecter au serveur, utilisez [kbd]tcp[/kbd] si vous êtes dans le doute';
...
$strSetupServers_extension_desc = 'Quelle extension PHP utiliser; vous devriez choisir mysqli si possible';
...
$strSetupServers_history_desc = 'Laisser vider pour désactiver l\'historique des requêtes SQL, suggéré : [kbd]pma_history[/kbd]';
...
$strSetupServers_pdf_pages_desc = 'Laisser vider pour désactiver le support des schémas en PDF, suggéré : [kbd]pma_pdf_pages[/kbd]';
...
$strSetupShowPhpInfo_desc = 'Montre un lien vers le résultat de [a@http://php.net/manual/function.phpinfo.php]phpinfo()[/a]';
...
$strSetupShowSQL_desc = 'Détermine si les requêtes SQL générées par phpMyAdmin devraient être affichées';
$strSetupShowSQL_name = 'Afficher les requêtes SQL';
$strSetupShowStats_desc = 'Affiche les statistiques sur les bases de données et les tables (espace utilisé)';
...
$strShowStatusHandler_updateDescr = 'Le nombre de requêtes de mise à jour de lignes dans une table.';
$strShowStatusHandler_writeDescr = 'Le nombre de requêtes d\'insertion de lignes dans une table.';
...
$strSocketProblem = '(ou l\'interface de connexion vers le serveur MySQL local n\'est pas correctement configurée)';
...
$strValidatorError = 'Le validateur SQL n\'a pas pu être initialisé. Vérifiez que les extensions PHP nécessaires ont bien été installées tel que décrit dans la %sdocumentation%s.';
$strValue = 'Valeur';
$strVar = 'Variable';
...
$strViewDumpDB = 'Voir une exportation (schéma) de la base de données';
...
$strWindowNotFound = 'La fenêtre demandée depuis votre navigateur ne peut être rafraîchie. Il est possible que vous ayez fermé la fenêtre source , ou encore que votre navigateur bloque les mises à jour inter-fenêtres pour des raisons de sécurité.';
