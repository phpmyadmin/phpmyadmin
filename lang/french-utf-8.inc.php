...
$strCreateNewTableShort = 'Créer une table';
...
$strJavascriptDisabled = 'Javascript est désactivé ou manquant dans votre fureteur, certaines fonctions de phpMyAdmin seront manquantes. Par exemple le cadre de navigation ne sera pas mis à jour automatiquement.';
$strJoins = 'Jointures';
...
$strPDFPageCreated = 'La page a été créée.';
$strPDFPageCreateFailed = 'Échec de création de page';
$strPDF = 'PDF';
...
$strPmadbCreateConfig = 'Activez les fonctions avancées dans le fichier de configuration (<code>config.inc.php</code>), en vous basant par exemple sur <code>config.sample.inc.php</code>.';
$strPmadbCreateHelp = 'Guide rapide de configuration des fonctions avancées :';
$strPmadbCreateTables = 'Créez les tables requises au moyen de <code>script/create_tables.sql</code>.';
$strPmadbCreateUser = 'Créez un utilisateur pma et donnez-lui accès à ces tables.';
$strPmadbReLoginToEnable = 'Reconnectez-vous à phpMyAdmin afin d\'utiliser le fichier de configuration modifié.';
...
$strReloadNavi = 'Recharger le cadre de navigation';
...
$strRenameView = 'Changer le nom de la vue pour';
$strRepair = 'Réparer';
...
$strSetupServers_auth_http_realm_desc = 'Domaine de protection (realm) à afficher lors d\'une authentification HTTP Basic';
$strSetupServers_auth_http_realm_name = 'Domaine de protection HTTP';
...
$strShowInsert = 'Afficher l\'énoncé d\'insertion';
...
$strSQLExportUTC = 'Exporter l\'heure en UTC';
