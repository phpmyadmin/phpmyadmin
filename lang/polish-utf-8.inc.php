...
$strDoYouReally = 'کیا آپ یقیناً کرنا چاہتے ہیں';
...
$strHaveToShow = 'آپ کو کم از کم ایک کالم چننا ہو گا ڈسپے کیلئے۔';
$strHebrew = 'Hebrajski';
$strHelp = 'Pomoc';
...
$strOptimizeTable = 'ٹیبلز آپٹی مائز ';
$strOptions = 'Opcje';
$strOr = 'یا';
$strOverhead = 'Nadmiar';
...
$strStatement = 'Cecha';
$strStatCheckTime = 'آخری دفعہ چیک';
...
$strStatUpdateTime = 'آخری دفعہ اپ ڈیٹ';
$strStatus = 'حالت';
