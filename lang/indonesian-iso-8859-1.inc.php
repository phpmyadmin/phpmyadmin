...
$strAddPriv = 'Menambahkan hak (privilege) baru';
$strAddPrivMessage = 'Hak (privilege) baru telah ditambahkan.';
...
$strDeleteUserMessage = 'Pemakai %s telah dihapus.';
...
$strDumpComments = 'Tambahkan komentar kolom sebagai Inline SQL-Comment';
...
$strNoUsersSelected = 'Tidak ada pemakai yang dipilih.';
...
$strPrimary = 'PRIMARY';
$strPrimaryKey = 'Kunci utama (Primary Key)';
...
$strQueryFrameDebugBox = 'Variabel yang aktif dari form pencarian:\nDB: %s\nTable: %s\nServer: %s\n\nBuat variabel untuk form pencarian:\nDB: %s\nTable: %s\nServer: %s\n\nLokasi dari Opener: %s\nLokasi dari Frameset: %s.';
...
$strRevokeGrant = 'Cabut hak akses yang berstatus Grant';
$strRevokeGrantMessage = 'Hak akses yang berstatus Grant untuk %s telah dicabut';
...
$strSQPBugSyntaxError = 'Kesalahan pada sintaksis';
...
$strUpdateProfile = 'Update profil pemakai:';
