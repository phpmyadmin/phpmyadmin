 ...
 * Modifications:
 *     Branislav Jovanovic <branej@users.sourceforge.net>, Mihailo Stefanovic <mst@mikis.org>
 * Serbian Cyrillic version by:
...
$strAccessDeniedExplanation = 'phpMyAdmin је покушао да се повеже на MySQL сервер, али је сервер одбио повезивање. Проверите назив хоста, корисничко име и шифру у config.inc.php и уверите се да одговарају подацима које сте добили од администратора MySQL сервера.';
$strAction = 'Акција';
...
$strAddPrivMessage = 'Управо сте додали привилегију.';
...
$strAddToIndex = 'Додај кључ';
$strAddUser = 'Додај новог корисника';
$strAddUserMessage = 'Управо сте додали корисника.';
$strAddedColumnComment = 'Додај коментар колони';
$strAddedColumnRelation = 'Додата релација колони';
$strAdministration = 'Администрација';
$strAffectedRows = 'Обухваћени записи:';
$strAfter = 'После %s';
$strAfterInsertBack = 'Назад на претходну страну';
$strAfterInsertNewInsert = 'Додај још један ред';
$strAll = 'Све';
...
$strCopyTableOK = 'Табела %s је управо копирана у %s.';
...
$strCreate = 'Креирај';
$strCreateIndex = 'Креирај кључ са&nbsp;%s&nbsp;колона';
$strCreateIndexTopic = 'Креирај нови кључ';
$strCreateNewDatabase = 'Креирај базу података';
$strCreateNewTable = 'Креирај нову табелу у бази %s';
...
$strDatabaseHasBeenDropped = 'База %s је обрисана.';
$strDatabaseNoTable = 'База не садржи табеле!';
$strDatabaseWildcard = 'База (џокер знаци дозвољени):';
$strDatabases = 'базе';
$strDatabasesDropped = '%s база је успешно обрисано.';
$strDatabasesStats = 'Статистика базе';
$strDatabasesStatsDisable = 'Искључи статистике';
$strDatabasesStatsEnable = 'Укључи статистике';
$strDatabasesStatsHeavyTraffic = 'Напомена: укључивање статистика може проузроковати велики саобраћај између web и MySQL сервера.';
...
$strDrop = 'Обриши';
$strDropDB = 'Обриши базу %s';
$strDropSelectedDatabases = 'Одбаци изабране базе';
$strDropTable = 'Обриши табелу';
$strDropUsersDb = 'Одбаци базе које се имају исто име као корисници.';
$strDumpComments = 'Укључи коментаре колона као коментаре унутар SQL-a';
$strDumpSaved = 'Схема је снимљена у фајл %s.';
$strDumpXRows = 'Прикажи %s редова почевши од реда %s.';
$strDumpingData = 'Извоз података табеле';
...
$strEnglish = 'Енглески';
$strEnglishPrivileges = ' Инфо: MySQL имена привилегија морају да буду на енглеском ';
$strError = 'Грешка';
...
$strField = 'Поље';
$strFieldHasBeenDropped = 'Поље %s обрисано';
$strFields = 'Број поља';
$strFieldsEmpty = ' Број поља је нула! ';
$strFieldsEnclosedBy = 'Подаци ограничени са';
$strFieldsEscapedBy = 'Ескејп карактер &nbsp; &nbsp; &nbsp;';
$strFieldsTerminatedBy = 'Подаци раздвојени са';
$strFileAlreadyExists = 'Фајл %s већ постоји на серверу, промените име фајла или укључите опцију преписивања.';
$strFileCouldNotBeRead = 'Датотеку није могуће прочитати';
$strFileNameTemplate = 'Шаблон имена фајла';
...
$strFixed = 'сређено';
$strFlushPrivilegesNote = 'Напомена: phpMyAdmin узима привилегије корисника директно из MySQL табела привилегија. Садржај ове табеле може се разликовати од привилегија које сервер користи ако су вршене ручне измене. У том случају %sпоново учитајте привилегијес%s пре него што наставите.';
$strFlushTable = 'Освежи табелу ("FLUSH")';
$strFormEmpty = 'Недостаје вредност у формулару!';
$strFormat = 'Формат';
...
$strHasBeenAltered = 'је промењен.';
$strHasBeenCreated = 'је креиран.';
...
$strHost = 'Хост (домен)';
$strHostEmpty = 'Име домена је празно!';
...
$strInsecureMySQL = 'Ваш конфигурациони фајл садржи подешавања (root без шифре) која одговарају стандардном MySQL привилегованом налогу. Ваш MySQL сервер ради са овим подешавањима, отворен је за упаде, и заиста треба да исправите овај сигурносни ризик.';
$strInsert = 'Нови запис';
$strInsertAsNewRow = 'Унеси као нови запис';
$strInsertNewRow = 'Унеси нови запис';
$strInsertTextfiles = 'Увези податке из текстуалне датотеке';
$strInsertedRowId = 'ID уметнутих редова:';
$strInsertedRows = 'Унесени записи:';
...
$strJustDeleteDescr = '&quot;Obrisani&quot; корисници ће и даље имати приступ серверу док привилегије не буду поново учитане.';

$strKeepPass = 'Немој да мењаш шифру';
...
$strLimitNumRows = 'Број записа по страни';
...
$strMIME_transformation_options_note = 'Молимо унесите вредности за опције трансформације користећи овај облик: \'a\',\'b\',\'c\'...<br />Ако треба да унесете обрнуту косу црту ("\") или апостроф ("\'") у те вредности, ставите обрнуту косу црту ипред њих (на пример \'\\\\xyz\' или \'a\\\'b\').';
...
$strMustSelectFile = 'Морате изабрати фајл који желите да уметнете.';
...
$strNoModification = 'Нема никаквих промена';
$strNoOptions = 'Не постоје опције за овај формат';
$strNoPassword = 'Нема шифре';
$strNoPermission = 'Beb серверу није дозвољено да сними фајл %s.';
...
$strNoSpace = 'Недовољно простора за снимање фајла %s.';
$strNoTablesFound = 'Табела није пронађена у бази.';
...
$strNotValidNumber = 'није одговарајући број записа!';
$strNull = 'Null';
...
$strPassword = 'Шифра';
$strPasswordChanged = 'Шифра за %s је успешно промењена.';
$strPasswordEmpty = 'Шифра је празна!';
$strPasswordNotSame = 'Шифра није идентична!';
...
$strPmaUriError = '<tt>$cfg[\'PmaAbsoluteUri\']</tt> део MORA бити подешен у конфигурационом фајлу!';
$strPortrait = 'Усправно';
$strPos1 = 'Почетак';
$strPrevious = 'Претходна';
$strPrimary = 'Примарни кључ';
$strPrimaryKey = 'Примарни кључ';
$strPrimaryKeyHasBeenDropped = 'Примарни кључ је избрисан';
$strPrimaryKeyName = 'Име примарног кључа мора да буде... PRIMARY!';
$strPrimaryKeyWarning = '("PRIMARY" <b>може и мора</b> да буде име и <b>само</b> име примарног кључа!)';
$strPrint = 'Штампај';
$strPrintView = 'За штампу';
$strPrivDescAllPrivileges = 'Укључи све привилегије осим GRANT.';
$strPrivDescAlter = 'Дозволи измену структура постојећих табела.';
$strPrivDescCreateDb = 'Дозволи креирање нових база и табела.';
$strPrivDescCreateTbl = 'Дозволи креирање нових табела.';
$strPrivDescCreateTmpTable = 'Дозволи креирање привремених табела..';
$strPrivDescDelete = 'Дозволи брисање података.';
$strPrivDescDropDb = 'Дозволи брисање база и табела.';
$strPrivDescDropTbl = 'Дозволи брисање табела.';
$strPrivDescExecute = 'Дозвољава покретање сачуваних процедура. Нема ефекта у овој верзији MySQL-a.';
$strPrivDescFile = 'Дозволи увоз и извоз података у фајлове.';
$strPrivDescGrant = 'Дозволи додавање корисника и привилегија без поновног учитавања табела.';
$strPrivDescIndex = 'Дозволи креирање и брисање индекса.';
$strPrivDescInsert = 'Дозволи уметање и замену података.';
$strPrivDescLockTables = 'Дозволи закључавање табела текућим процесима.';
$strPrivDescMaxConnections = 'Ограничава број нових конекција које корисник може та отвори на сат.';
$strPrivDescMaxQuestions = 'Ограничава број упита које корисник може та отвори на сат.';
...
$strPrivDescSuper = ' Дозвољава повезивање иако је достигнут максималан број дозвољених веза; Неопходно за већину административних опција као што су подешавање глобалних променљивих или прекидање нити осталих корисника.';
$strPrivDescUpdate = 'Дозволи измену података.';
...
$strQueryWindowLock = 'Немојте преписивати овај упит изван прозора';

$strReType = 'Поновите унос';
$strReceived = 'Примљено';
$strRecords = 'Записи';
$strReferentialIntegrity = 'Провери валидност линкова:';
...
$strRemoveSelectedUsers = 'Обриши изабране кориснике';
...
$strReplaceTable = 'Замени податке у табели са датотеком';
$strReset = 'Ресетуј';
...
$strRowLength = 'Дужина записа';
$strRowSize = 'Величина записа';
$strRows = 'Записа';
$strRowsFrom = ' редова почев од записа';
...
$strSave = 'Сачувај';
$strSaveOnServer = 'Сними на сервер у директоријум %s';
...
$strSearchType = 'Тражи:';
$strSecretRequired = 'Конфигурациони фајл захтева тајну шифру (blowfish_secret).';
$strSelect = 'Селектуј';
$strSelectADb = 'Изаберите базу';
$strSelectAll = 'Селектуј све';
$strSelectFields = 'Изабери поља (најмање једно)';
$strSelectNumRows = 'у упиту';
$strSelectTables = 'Изабери табеле';
$strSend = 'Сачувај у датотеку';
$strSent = 'Послато';
$strServer = 'Сервер %s';
...
$strSetEnumVal = 'Ако је поље "енум" или "сет", унесите вредности у формату: \'a\',\'b\',\'c\'...<br />Ако вам треба обрнута коса црта ("\") или једноструки знак навода ("\'") користите их у ескејпованом облику (на пример \'\\\\xyz\' или \'a\\\'b\').';
$strShow = 'Прикажи';
...
$strTable = 'Табела';
$strTableComments = 'Коментар табеле';
$strTableEmpty = 'Има табеле је празно!';
$strTableHasBeenDropped = 'Табела %s је обрисана';
...
$strTextAreaLength = 'Због величине овог поља,<br /> поље нећете моћи да измените';
$strTheContent = 'Садржај датотеке је додат у вашу базу.';
$strTheContents = 'Садржај табеле замени са садржајем датотеке са идентичним примарним и јединственим (unique) кључем.';
$strTheTerminator = 'Сепаратор поља у датотеци.';
$strThisHost = 'Овај сервер';
$strThisNotDirectory = 'Ово није директоријум';
$strThreadSuccessfullyKilled = 'Нит %s је успешно прекинута.';
$strTime = 'Време';
...
$strTransformation_image_jpeg__link = 'Приказује а ка овој снимци (нпр. директно презуимање из BLOB-а).';
...
$strUncheckAll = 'Демаркирај све';
$strUnique = 'Јединствени кључ';
$strUnselectAll = 'Деселектуј све';
$strUpdComTab = 'Молимо видите документацију о томе како ажурирати табелу Column_comments';
$strUpdatePrivMessage = 'Променили сте привилегије за %s.';
$strUpdateProfile = 'Промени профил:';
$strUpdateProfileMessage = 'Профил је промењен.';
$strUpdateQuery = 'Ажурирај SQL упит';
$strUsage = 'Заузеће';
...
$strValue = 'Вредност';
$strVar = 'Променљива';
$strViewDump = 'Прикажи дамп (схему) табеле';
$strViewDumpDB = 'Прикажи дамп (схему) базе';
$strViewDumpDatabases = 'Прикажи схему базе';
