...
$strAction = "Akcia";
$strAddDeleteColumn = ""; //to translate
$strAddDeleteRow = ""; //to translate
...
$strColumn = "Ståpec";
$strColumnEmpty = "Názvy ståpcov sú prázdne!";
...
$strEnableMagicQuotes = "<b>Varovanie:</b> Nemáte zapnuté magic_quotes_gpc vo Va¹ej konfigurácii PHP. PhpMyAdmin to potrebuje pre správnu funkènos». Prosím pozrite sa do manuálu konfigurácie PHP ako toto nastavenie zmeni».";
...
$strInsertIntoTable = "Vlo¾i» do tabuµky";
...
$strPrinterFriendly = "Verzia pre tlaè";
