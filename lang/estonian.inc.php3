...
$strAny = 'kõik';
$strAnyColumn = 'Ükskõik milline veerg';
$strAnyDatabase = 'Ükskõik milline andmebaas';
$strAnyHost = 'Ükskõik milline host';
$strAnyTable = 'Ükskõik milline tabel';
$strAnyUser = 'Ükskõik milline kasutaja';
...
$strCreate = 'Loo';
$strCreateIndex = 'Loo indeks &nbsp;%s&nbsp;veergudest';
...
$strDrop = 'Kustuta';
$strDropDB = 'Kustuta andmebaasid %s';
...
$strIfYouWish = 'Kui soovite lugeda ainult mõningaid tabeli veerge, sisestage komaga eraldatud väljade loetelu.';
$strIgnore = 'Ignoreeri';
$strIndex = 'Indeks';
$strIndexes = 'Indeksid';
...
$strMySQLServerProcess = 'MySQL %pma_s1% jookseb %pma_s2% - %pma_s3%';
...
$strRunning = 'jookseb %s';
$strRunQuery = 'Lae päring';
$strRunSQLQuery = 'Jooksuta SQL päring/päringuid andmebaasis %s';

$strSave = 'Salvesta';
$strSelect = 'Vali';
$strSelectADb = 'Palun valige andmebaas';
$strSelectAll = 'Vali kõik';
...
$strUncheckAll = 'Tühjenda kõik';
$strUnique = 'Unikaalne';
$strUnselectAll = 'Tühjenda kõik';
