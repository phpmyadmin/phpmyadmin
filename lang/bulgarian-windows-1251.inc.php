...
$strAfterInsertBack = 'въщане обратно';
...
$strChangeCopyModeDeleteAndReload = ' ... изтриване на стария от таблицата на потрбителите и след това презареждане на привилегиите.';
...
$strDropSelectedDatabases = 'Изтрване на избраните бази от данни';
...
$strFileNameTemplateHelp = 'Използвайте __DB__ за име на базата от данни, __TABLE__ за име на таблицата и опциите на %sstrftime%s за указавне на формата на времето, като разширенито ще бъде добавено автоматично. Всеки друг текст ще бъде запазен.';
...
$strHebrew = 'Иврит';
$strHexForBinary = 'Използване на шестнадесетично представяне за двуичните полета';
...
$strOftenQuotation = 'Обикновено кавички. Незадължително означава, че само полета char и varchar се заграждат в кавички.';
$strOK = 'OK';
$strOperations = 'Операции';
$strOperator = 'Оператор';
$strOptimizeTable = 'Оптимизация на таблицата';
$strOptionalControls = 'Незадължително. Контролира как да се четат или пишат специални символи.';
$strOptionally = 'Незадължително';
$strOr = 'или';
...
$strPrivDescMaxUpdates = 'Органичава броя на командите, които променят някоя таблица или база от данни, които даден потребител може да стартира за час.';
...
$strDBCopy = 'Копиране на базата от данни в';  //to translate
...
$strIndexWarningTable = 'Проблем с индексите на таблица `%s`';//to translate
