...
$strCoordsNotSet = 'tabela table_coords nuk u gjet apo nuk është përcaktuar tek config.inc.php3';
...
$strInfoNotSet = 'tabela table_info nuk u dhet apo nuk është përcaktuar tek config.inc.php3';
$strInsert = 'Shto';
...
$strRelationNotSet = 'Relationtable nuk u gjet ose nuk është përcaktuar tek config.inc.php3';
