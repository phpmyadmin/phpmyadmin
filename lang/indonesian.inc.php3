...
$day_of_week = array ('Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab');
$month = array ('Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agst', 'Sept', 'Okt', 'Nop', 'Des');
...
$strCookiesRequired = 'Mulai dari sini, fungsi Cookies harus diaktifkan.';
...
$strDatabasesStats = 'Statistik dari semua Database';
...
$strDynamic = 'secara dinamis';

$strEdit = 'Ubah';
$strEditPrivileges = 'Ubah hak akses';
$strEffective = 'Efektif';
$strEmpty = 'Hapus';
$strEmptyResultSet = 'MySQL balikkan hasil kosong (a.k. baris kosong).';
$strEnd = 'End';
...
$strIfYouWish = 'Bila selera tampilan jumlah kolom dari tabel dijaring, pisahkan daftar field dengan separator tanda koma.';
...
$strInUse = 'dipakai';
$strInvalidName = '"%s" adalah kata khusus dan tidak dapat dipergunakan sebagai nama database/tabel/field.';
...
$strMySQLServerProcess = 'MySQL %pma_s1% berjalan diatas %pma_s2% sebagai %pma_s3%';
...
$strNext = 'Berikut';
$strNo = 'Tidak';
$strNoDatabases = 'Tidak ditemukan database';
$strNoDropDatabases = 'Perintah "DROP DATABASE" di nonaktifkan.';
$strNoFrames = 'phpMyAdmin berfungsi lebih ramah dengan tipe browser yang memiliki fungsi <b>frames-capable</b>.';
...
$strNoQuery = 'Tidak ada SQL-query!';  //to translate
...
$strOftenQuotation = 'Sering terpakai tanda kutip. OPTIONALLY berarti bahwa hanya field char dan varchar yang ditutup oleh karakter "enclosed by" tersebut.';
...
$strReloadFailed = 'Reload MySQL gagal.';
$strReloadMySQL = 'Reloading MySQL';
...
$strRowsStatistic = 'Statistik dari baris';
$strRunning = 'diatas %s';
...
$strSize = 'Ukuran';
$strSort = 'Urutkan';
$strSpaceUsage = 'Pemakaian tempat';
