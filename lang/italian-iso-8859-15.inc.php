...
$strFileNameTemplateDescription = 'Questo valore è interpretato usando %1$sstrftime%2$s, in questo modo possono essere usate stringhe formattate. Per le successive formattazioni sarà: %3$s. Il resto del testo è tenuto esattamente come è.';
...
$strInvalidCSVInput = 'CSV input non valido, impossibile processarlo!';
...
$strInvalidServerHostname = 'Hostname non valido per il server %1$s. Controlla la tua configurazione.';
$strInvalidServerIndex = 'Indice del server non valido: "%s"';
