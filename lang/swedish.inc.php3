...
$day_of_week = array('Sön', 'M=86n', 'Tis', 'Ons', 'Tors', 'Fre', 'Lör');
...
$strAnd = 'Och';
$strAnIndex = 'Ett index har lagt till på %s';
$strAny = 'Någon';
$strAnyColumn = 'Lägg till kolumn';
...
$strFieldsEnclosedBy = 'Fälten omslutna av'; //Rätt???
$strFieldsEscapedBy = 'Fälten undgicks av'; //Rätt???
$strFieldsTerminatedBy = 'Fälten avslutade med';
$strFixed = 'fast';
$strFormat = 'Format';
...
$strReset = 'Nollställ';
$strReType = 'Skriv om';
$strRevoke = 'Upphäv'; //Rätt???
$strRevokeGrant = 'Upphäv godkännanden'; //Rätt???
$strRevokeGrantMessage = 'Du har upphävt godkännande privilegierna för'; //Rätt???
$strRevokeMessage = 'Du har upphävt godkännandena för'; //Rätt???
$strRevokePriv = 'Upphäv Privilegierna';
...
$strRunSQLQuery = 'Kör SQL fråga/frågor på databasen %s';
