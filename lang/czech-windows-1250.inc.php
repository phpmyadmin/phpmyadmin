...
$strBinaryLogCache = 'Vyrovnávací pamì binárního logu'; 
...
$strMIME_transformation_options_note = 'Zadejte parametry transformací v&nbsp;následujícím tvaru: \'a\',\'b\',\'c\'...<br />Pokud potøebujete pouít zpìtné lomítko (&dbquo;\&ldquo;) nebo jednoduché uvozovky (&dbquo;\'&ldquo;) mezi tìmito hodnotami, vlote pøed nì zpìtné lomítko (napøíklad \'\\\\xyz\' nebo \'a\\\'b\').';
...
$strNoFrames = 'phpMyAdmin se lépe pouívá v&nbsp;prohlíeèi podporujícím rámy (&dbquo;FRAME&ldquo;).';
$strNoIndex = 'Není definován ádnı index!';
...
$strPrimaryKeyWarning = '(&dbquo;PRIMARY&ldquo; <b>musí</b> bıt jméno <b>pouze</b> primárního klíèe!)';
$strPrimary = 'Primární';
...
$strSetEnumVal = 'Pokud je sloupec typu &bdquo;enum&ldquo; nebo &bdquo;set", zadávejte hodnoty v&nbsp;následujícím formátu: \'a\',\'b\',\'c\'...<br />Pokud potøebujete zadat zpìtné lomítko (&dbquo;\&ldquo;) nebo jednoduché uvozovky (&dbquo;\'&ldquo;) mezi tìmito hodnotami, napište pøed nì zpìtné lomítko (pøíklad: \'\\\\xyz\' nebo \'a\\\'b\').';
