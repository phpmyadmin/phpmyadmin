...
$strError = 'Chyba';
$strEscapeWildcards = 'Zástupné znaky _ a % by mìly bıt eshould be escapovány pomocí \, pokud je chcete pouít jako znak';
...
$strIndexWarningPrimary = 'Sloupec `%s` by nemìl bıt zárovìò obsaen v&nbsp;PRIMARY a INDEX klíèi';
$strIndexWarningTable = 'Problémy s&nbsp;indexy v&nbsp;tabulce `%s`';
$strIndexWarningUnique = 'Sloupec `%s` by nemìl bıt zárovìò obsaen v&nbsp;PRIMARY a UNIQUE klíèi';
$strIndexes = 'Indexy';
...
$strNext = 'Další';
$strNo = 'Ne';
$strNoActivity = 'Byli jste pøíliš dlouho neaktivní (déle ne %s sekund), prosím pøihlašte se znovu';
