...
$strCopyTableOK = "ตาราง %s ได้ทําการสําเนาไปเป็น %s เรียบร้อยแล้ว.";#"Table %s has been copied to %s.";
...
$strRenameTableOK = "ตาราง %s ได้ถูกเปลี่ยนชื่อเป็น %s";#"Table %s has been renamed to %s";
