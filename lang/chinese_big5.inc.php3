...
$strAddPriv = '增加新權限';
$strAddPrivMessage = '您已經為下面這位使用者增加了新權限.'; //您已經為下面這位使用者增加了新權限(this variable can't show Chinese correctly)
$strAddSearchConditions = '增加檢索條件 ("where" 子句的主體)';
$strAddToIndex = '新增 &nbsp;%s&nbsp; 組索引欄';
$strAddUser = '新增使用者';
$strAddUserMessage = '您已新增了一個新使用者.'; //您已新增了一個新使用者(this variable can't show Chinese correctly)
...
$strDropDB = '刪除資料庫';
$strDropTable = '刪除資料表';
$strDumpingData = '列出以下資料庫的數據：'; //should expressed in English
$strDynamic = '動態';
...
$strRememberReload = '請記著重新啟動伺服器.'; //(this variable can't show Chinese correctly)
...
$strTables = '%s 資料表';
$strTableStructure = '資料表格式：'; //should expressed in English
$strTableType = '資料表類型';
