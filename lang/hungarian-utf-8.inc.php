...
$strAccessDeniedExplanation = 'A phpMyAdmin ,egpróbált csatlakozni a MySQL szerverhez, de a szerver elutasította a kapcsolatot. Ellenőrizze a host, username és jelszó mezőket a config.inc.php fájlban, és bizonyosodjon meg róla, hogy ezek megfelelnek a MySQL szerver adminisztrátorától kapott információknak.';  
$strAction = 'Parancs';
...
$strChangeCopyModeRevoke = ' ... az összes aktív privilégium visszaállítása a régiből, éa utána törlésük.';  
...
$strDumpComments = 'Oszlop-megjegyzések beszúrása belső SQL-megjegyzésként';
...
$strFixed = 'rögzített';
$strFlushPrivilegesNote = 'Megjegyzés: a phpMyAdmin a felhasználói privilágiumokat közvetlenül a MySQL privilágium táblákból veszi. Ezen táblák tartalma eltérhet a szerver privilégiumoktól, ha ezt kézzel beállítottuk. Ebben az esetben érdemes %sújra betölteni a privilégiumokat%s a folytatás előtt.'; 
...
$strMIME_transformation_note = 'Az elérhető átalakítási beállítások listájához és a hozzájuk tartozó MIME-tipusokhoz akttintson ide: %stransformation descriptions%s';
$strMIME_transformation_options = 'Átalakítás beállítások';
$strMIME_transformation_options_note = 'Az átalakítás beállításokhoz írja be az értékeket a kovetkező formátumban: \'a\',\'b\',\'c\'...<br />Ha visszapert ("\") vagy idézőjelet ("\'") akar beszúrni, használjon visszapert (for example \'\\\\xyz\' or \'a\\\'b\').';
$strMIME_without = 'A dőlttel írt MIME-tipusok nem válaszrtják el az átalakítási funkciókat';
...
$strNoUsersSelected = 'Nincs felhasználó kiválasztva.'; 
...
$strPHP40203 = 'A PHP 4.2.3-mas verziója fut, ami egy súlyos hibát tartalmaz a több-bájtos sztringek kezelésénél (mbstring). Nézze meg a következőt: PHP bug report 19404. A PHP ezen verzója nem ajánlott a phpMyAdminhoz.';  
...
$strPrivDescAlter = 'Engedélyezi a látező táblák szerkezetének megváltoztatását.'; 
...
$strQueryFrameDebug = 'Hibakereső információ';
$strQueryFrameDebugBox = 'Aktív változók a lekérési űrlaphoz:\nDB: %s\nTábla: %s\nSzerver: %s\n\nJelenlegi Current változók a lekérési űrlaphoz:\nDB: %s\nTábla: %s\nSzerver: %s\n\nMegnyitó hely: %s\nFrameset hely: %s.';
...
$strSQPBugSyntaxError = 'Szintaktikai hiba';  
