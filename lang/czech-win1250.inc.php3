...
$strAnd = 'a';
$strAnIndex = 'Index byl pøidán k tabulce %s';
$strAny = 'Jakýkoliv';
...
$strAPrimaryKey = 'Primární klíè byl pøidán v tabulce %s';
...
$strField = 'Pole';
$strFieldHasBeenDropped = 'Pole %s bylo odstranìno';
$strFields = 'Poèet polí';
$strFieldsEmpty = ' Nebyl zadán poèet polí! ';
$strFieldsEnclosedBy = 'Položky uzavøené do';
$strFieldsEscapedBy = 'Položky escapovány';
$strFieldsTerminatedBy = 'Položky oddìlené';
$strFixed = 'pevný'; 
$strFormat = 'Formát'; 
