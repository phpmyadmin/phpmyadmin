...
$strCoordsNotSet = 'Tabulka se souøadnicemi tabulek (table_coords) nenalezena nebo není nastavena v&nbsp;config.inc.php3';
...
$strInfoNotSet = 'Tabulka s&nbsp;informacemi o&nbsp;klíèích (table_info) nenalezena nebo není nastavena v&nbsp;config.inc.php3';
$strInsert = 'Vloit';
...
$strRelationNotSet = 'Tabulka s&nbsp;relacemi (relation) nenalezena nebo není nastavená v&nbsp;config.inc.php3';
