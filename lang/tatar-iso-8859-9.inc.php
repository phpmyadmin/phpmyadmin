...
$strAccessDeniedExplanation = 'phpMyAdmin bu MySQL servergä totaþýlýp qaraðaç, server bu totaþýluýn özep quydý. Xäzer, "config.inc.php" biremendä kertelgän sanaq/ireþisem/sersüzlär tikäserep, alarný MySQL idäräçese birgän mäðlümät belän çaðýþtýrýp qarísý qala.';
$strAction = 'Ðämäl';
