...
$strAction = 'Dzialanie';
$strAddDeleteColumn = 'Dodanie/usuniecie pól';
$strAddDeleteRow = 'Dodanie/usuniecie wierszów kryteriów';
...
$strDisableMagicQuotes = '<b>Ostrzezenie:</b> Wlaczono opcje magic_quotes_gpc w konfiguracji PHP. Ta wersja PhpMyAdmin zle dziala, gdy opcja ta jest wylaczona. Prosze zaznajomic sie dokumentacja do PHP, aby znalezc informacje, w jaki sposób wylaczyc te opcje.';
$strDisplay = 'Pokaz';
...
$strEmptyResultSet = 'MySQL zwrócil pusty wynik (np. zero rekordów).';
$strEnableMagicQuotes = '<b>Ostrzezenie:</b> Wylaczono opcje magic_quotes_gpc w konfiguracji PHP. Ta wersja PhpMyAdmin zle dziala z wylaczona ta opcja. Prosze zaznajomic sie dokumentacja do PHP w aby znalezc informacje w jaki sposób wlaczyc te opcje..';
...
$strMySQLSaid = 'MySQL zwrócil komunikat: ';
...
$strNoUsersFound = 'Nie znaleziono uzytkownika(ów).';
$strNull = 'Null';
$strNumberIndexes = ' ilosc zaawansowanych indeksów ';
...
$strOptionalControls = 'Opcjonalnie. Okreslenie w jaki sposób zapisac lub odczytac znaki specjalne.';
...
$strRows = 'Ilosc rekordów';
$strRowSize = ' Rozmiar rekordu ';
$strRowsFrom = 'rekordów poczawszy od';
...
$strTheContents = 'Zawartosc pliku zastapila dane wybranej tabeli, których podstawowy lub unikalny klucz byl identyczny.';
...
$strUseBackquotes = 'Uzycie cudzyslowów z nazwami tabel i pól';
$strUser = 'Uzytkownik';
