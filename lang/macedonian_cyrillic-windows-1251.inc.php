...
$strFields = 'Полиња';
$strFieldsEmpty = ' Бројот на полиња е нула! ';
...
$strIndexWarningUnique = 'UNIQUE и INDEX клучевите не би требало да бидат истовремено поставени за колоната `%s`';
$strIndexes = 'Клучеви';
