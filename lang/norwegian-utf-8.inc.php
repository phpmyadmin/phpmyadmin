...
$strSetupServers_relation_desc = 'La stå tom for ingen [a@http://wiki.phpmyadmin.net/pma/relation]relasjonslink[/a]støtte, suggested: [kbd]pma_relation[/kbd]';
...
$strSetupServers_designer_coords_desc = 'La stå tom for ingen Designer støtte, standard: [kbd]pma_designer_coords[/kbd]';
