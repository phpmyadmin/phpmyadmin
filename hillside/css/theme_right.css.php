...
table tr.even th,
.even {
    background-image:url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>transparent60.png);
}
...
body#bodyquerywindow {
    margin: 0;
    padding: 0;
	background-image:	url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>island_light.png);
}
