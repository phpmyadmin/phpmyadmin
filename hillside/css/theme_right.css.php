...
body {
    ...
    font-size:         11px;
    color: #000000;
         background: <?php echo $GLOBALS['cfg']['RightBgColor']; ?> url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>island_light.png) top left repeat-x;
...
fieldset        {
    ...
    background-image:url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>transparent.png);
}
fieldset fieldset {
    margin:     0.8em;
}
...
th              {
	...
	color: #FFF;
	background-color: transparent;
    background-image: url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>transparentdark.png);
}
th a:link {
	color:#FFF;
...
.tblHeaders a:hover, .tblFooters a:hover { color: #bdbdbd; }
.tblHeadError {
    background-color: #FF0000;
    font-weight: bold;
    color: #FFFFFF;
